...
<html>
	...
	<body>
		<a href="#edit-invoiceItem" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-invoiceItem" class="content scaffold-edit" role="main">
