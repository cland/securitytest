			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="name" title="${message(code: 'invoiceItem.name.label', default: 'Name')}" />
				...
				<g:each in="${invoiceItemInstanceList}" status="i" var="invoiceItemInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${invoiceItemInstance.id}">${fieldValue(bean: invoiceItemInstance, field: "name")}</g:link></td>
